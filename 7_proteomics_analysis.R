...
# Generates 4 files for supplementary table 10 and supplementary table 13
...
conditional_outfile <-
  'results/supplementary_table_10_proteomics_associations_proteinopathy.xlsx'
enzymes_outfile <-
  'results/supplementary_table_13_targeted_proteomics_association_w_ad.xlsx'
...
print("Generated excel files with supplementary tables 10 and 11 in results folder!")
